...
export class LeftBarComponent implements OnInit {
	...
	constructor(private overlay: OverlayContainer, private userThemeService: UserThemeService) {}
	...
	toggleThemes(): void {
		this.userThemeService.toggleThemes(this.toggleControl, this.overlay.getContainerElement());
