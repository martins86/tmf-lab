...
describe('Testes do LeftBarComponent', () => {
	...
	beforeEach(async () => {
		await TestBed.configureTestingModule({
			...
			imports: [DefaultModule, BrowserAnimationsModule, RouterTestingModule, TranslateStubModule],
	...
	describe('Testando o closeLeftBar', () => {
		it('Deve emitir o evento de fechar com emitCloseLeftBar', () => {
			...
			expect(component.emitCloseLeftBar.emit).toHaveBeenCalledWith('closeLeftBar');
		});
	});
