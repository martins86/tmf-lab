...
describe('Testes do BottomBarComponent', () => {
	...
	describe('Testando o texto traduzido em en no footer', () => {
		beforeEach(async () => {
			await TestBed.configureTestingModule({
				declarations: [BottomBarComponent],
				imports: [DefaultModule, RouterTestingModule, TranslateTestingModule.withTranslations('en', require('../../../../../assets/i18n/en.json'))],
			}).compileComponents();
		});
		...
		it('Deve ser exibido o texto "TMF Lab © All rights reserved 2023-currentYear" ', () => {
			...
			const textElement = textElementByCss(By.css('p')).textContent?.toString().trim();
	...
	describe('Testando o texto traduzido em pt no footer', () => {
		beforeEach(async () => {
			await TestBed.configureTestingModule({
				declarations: [BottomBarComponent],
				imports: [DefaultModule, RouterTestingModule, TranslateTestingModule.withTranslations('pt', require('../../../../../assets/i18n/pt.json'))],
			}).compileComponents();
		});
